...
export default function G7TravelsPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Best Prices',
      description: 'Transparent per/km pricing with zero hidden charges or fees'
    },
    {
      icon: <Car className="w-6 h-6" />,
      title: 'Variety of Vehicles',
      description: 'From Etios & Dzire to Innova Crysta and 50-seater Buses'
    },
    {
      ...
      <section className="relative py-16 bg-orange-50/40 backdrop-blur-lg z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-700 font-medium max-w-2xl mx-auto">
              Choose from our wide range of well-maintained vehicles at affordable prices
            </p>
          </div>
              ...
              >
                <Card className="text-center bg-white/80 backdrop-blur-md hover:shadow-xl transition-all hover:-translate-y-1 overflow-hidden border border-white/60">
                  <CardHeader className="pb-3">
                    <div className="mb-2 rounded-lg overflow-hidden bg-white p-2 border border-slate-100 h-32 flex items-center justify-center">
                      <img
                        src={vehicle.image}
                        alt={vehicle.name}
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-orange-600">
                      {vehicle.price === 'Custom' ? 'Custom Pricing' : (
                        <>
                          {vehicle.price}
