...
import { Car, Calendar, MapPin, Shield, Clock, Users, Star, Phone, Plane, Train, Bus, Map } from 'lucide-react'
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">Best Cab & Taxi Services in Tirupati</h1>
